...
const MAP = {
  ...
  KeyX: 'special',            // homing missile
  KeyZ: 'activate', Enter: 'activate', // Gradius power-up bar
...
class Input {
  ...
  get drift()   { return this.held.has('drift'); }
  get activate(){ return this.held.has('activate'); }
